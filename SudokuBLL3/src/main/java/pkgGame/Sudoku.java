...
public class Sudoku extends LatinSquare {
	...
	/**
	 *getRegionNbr - Return region number based on given column and row<br>
	 *
	 *Example, the following Puzzle:
	 *
	 *0 1 2 3 <br>
	...
	/**
	 * PrintPuzzle This method will print the puzzle to the console (space between columns, line break after row)
	 * 
	 * @version 1.3
	 * @since Lab #3
	 */
